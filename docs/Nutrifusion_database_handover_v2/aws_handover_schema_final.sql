...
CREATE TABLE consultation.session_hydration (
    id uuid DEFAULT public.uuid_generate_v7() NOT NULL,
    sessions_id uuid NOT NULL,
    water_intake_per_day numeric(6,1),
    urine_colour text,
...
CREATE TABLE sss.inventory_batch (
    ...
    inv_batch_testing_org_url text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    created_by uuid,
    updated_by uuid,
...
--
-- Name: sessions sessions_consultation_objective_id_fkey; Type: FK CONSTRAINT; Schema: consultation; Owner: -
--

ALTER TABLE ONLY consultation.sessions
    ADD CONSTRAINT sessions_consultation_objective_id_fkey FOREIGN KEY (consultation_objective_id) REFERENCES consultation.consultation_objective_lookup(id);
