...
\restrict ugquxg6WBhomVhOg7iW0KjZKpfdJpu53Yhbjx3b3L8gt8ZxOxGSXhazWez5hiXH
...
--
-- Name: consultation_objective_lookup; Type: TABLE; Schema: consultation; Owner: -
--

CREATE TABLE consultation.consultation_objective_lookup (
    id uuid DEFAULT public.uuid_generate_v7() NOT NULL,
    consultation_objective text NOT NULL,
    is_active boolean DEFAULT true NOT NULL
);
...
--
-- Name: consultation_objective_lookup consultation_objective_lookup_consultation_objective_key; Type: CONSTRAINT; Schema: consultation; Owner: -
--

ALTER TABLE ONLY consultation.consultation_objective_lookup
    ADD CONSTRAINT consultation_objective_lookup_consultation_objective_key UNIQUE (consultation_objective);


--
-- Name: consultation_objective_lookup consultation_objective_lookup_pkey; Type: CONSTRAINT; Schema: consultation; Owner: -
--

ALTER TABLE ONLY consultation.consultation_objective_lookup
    ADD CONSTRAINT consultation_objective_lookup_pkey PRIMARY KEY (id);
...
--
-- Name: consultation_objective_lookup audit_consultation_objective_lookup_changes; Type: TRIGGER; Schema: consultation; Owner: -
--

CREATE TRIGGER audit_consultation_objective_lookup_changes AFTER INSERT OR DELETE OR UPDATE ON consultation.consultation_objective_lookup FOR EACH ROW EXECUTE FUNCTION audit.audit_trigger_func();
...
--
-- Name: session_note session_note_consultation_objective_id_fkey; Type: FK CONSTRAINT; Schema: consultation; Owner: -
--

ALTER TABLE ONLY consultation.session_note
    ADD CONSTRAINT session_note_consultation_objective_id_fkey FOREIGN KEY (consultation_objective_id) REFERENCES consultation.consultation_objective_lookup(id);
...
\unrestrict ugquxg6WBhomVhOg7iW0KjZKpfdJpu53Yhbjx3b3L8gt8ZxOxGSXhazWez5hiXH
