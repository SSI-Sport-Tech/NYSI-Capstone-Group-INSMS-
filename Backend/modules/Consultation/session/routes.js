...
import { authenticateToken } from '../../Auth/authMiddleware.js'; // ✅ Added Auth

const router = express.Router();

// ============================================================================
// TRAINING SCHEDULE ROUTES (Target Event) - ✅ NEW SECTION
// ============================================================================
 ...
 * description: |
 * Update the training schedule details for a specific session.
 * This includes the "Target Event" (upcoming_major_competitions).
 * This performs an UPSERT (creates the record if it doesn't exist).
