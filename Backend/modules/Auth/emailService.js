        ...
        html: `
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <div class="message">
                            ...
                            <ul style="margin: 10px 0; padding-left: 20px;">
                                ...
                                <li>INSMS staff will never ask for this code</li>
                    ...
                    <div class="footer">
                        <p>
                            This is an automated message from the INSMS Authentication System.<br>
                            © ${new Date().getFullYear()} High Performance Sport Institute. All rights reserved.
                        </p>
                        <p>
...
© ${new Date().getFullYear()} High Performance Sport Institute
        `.trim(),
    };
        ...
        html: `
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        <h2>Hi ${firstName},</h2>
                        <p>Your account has been successfully created! You can now access the INSMS Supplement Management System.</p>
